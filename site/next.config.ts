...
const nextConfig: NextConfig = {
  ...
  // Обложки новостей загружаются через Server Action, а он по умолчанию режет тело на 1 МБ —
  // обычное фото с телефона не проходило бы, хотя интерфейс и README обещают до 8 МБ.
  // Запас над 8 МБ нужен на служебные поля multipart-запроса.

...
function FooterLogos() {
  ...
  return (
    <span className="flex items-center">
      ...
      />
      {/* Крестик стоит по-разному на двух ширинах — так в самих макетах, это не наша
          вольность. По замеру видимых границ (метод одинаков для обеих):
            мобильная — РУДН до 93, крестик 106–115, X5 со 130: зазоры 12 и 14;
            десктоп   — РУДН до 118, крестик 124–133, X5 со 155: зазоры 5 и 21.
          То есть на десктопе крестик прижат к РУДН, а на мобильной стоит почти посередине.
          Сумма отступов в обоих случаях 32, поэтому X5 Tech не сдвигается.
          Значения — под видимые границы логотипов, а не под рамки картинок: у них
          есть прозрачные поля */}
      <img
        loading="lazy"
        src={asset("/img/13-footer/asset-463eeb0a.svg")}
        alt=""
        aria-hidden
        className="ml-[12px] mr-[10px] h-[10px] w-[10px] md:ml-[5px] md:mr-[17px]"
      />
      <img
        loading="lazy"

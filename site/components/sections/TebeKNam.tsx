...
// Ширина текстового блока каждой карточки. Значения макетные (там кегль 12), кроме второй:
// её самая длинная строка «Tech и строить карьеру в крупнейших» на нашем кегле 13 занимает
// 250px и в макетные 244 не влезала — строка доламывалась ещё раз, и «X5» с «крупнейших»
// повисали отдельными строками. 252 держит макетную разбивку; до правого края карточки
// остаётся 20px (в макете 39). Остальным трём запаса хватает: нужно 208/209/210 при 217/227/227.
const MOBILE_TEXT_W = [217, 252, 227, 227];

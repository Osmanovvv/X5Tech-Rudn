...
// Серый подзаголовок мобилы: в эталоне #818181, но на белом это контраст 3.90 при требуемых
// WCAG AA 4.5 — Lighthouse валил доступность. Взят ближайший проходящий #767676 (4.54).
// Разница с макетом на глаз не читается, а до нашего прежнего #6b6b6b (5.33) ещё далеко.
    ...
    <section aria-label="Факультет искусственного интеллекта РУДН и X5 Tech">
      ...
      <div className="canvas-320 relative overflow-hidden bg-white md:hidden">
        <div className="relative h-[284px]">
          ...
          <p data-reveal className="absolute left-[15px] top-[155px] text-[13px] leading-[15px] text-[#767676]">
            Факультет искусственного интеллекта РУДН
            <br />
            Образовательная программа:
            <br />

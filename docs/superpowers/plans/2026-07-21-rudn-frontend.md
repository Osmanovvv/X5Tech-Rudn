...
2. Сверка инструментом Task 0.4 (не «на глаз»): браузерный скриншот секции на **1200** и **320** (мобильная база макета — именно 320, не 390) → resize к общему размеру → pixelmatch; порог прохождения ≤ 2% отличающихся пикселей; спорные зоны — режимом наложения.
